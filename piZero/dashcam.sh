...
if [ -e /home/pi/Desktop/Videos/dashcam.log ]
then
    echo "found previous dashcam.log"
else
    echo "no dashcam log file \n creating one now"
    touch  /home/pi/Desktop/Videos/dashcam.log
fi
# mv the current video to the same name but with the date added  
if [ -e /home/pi/Desktop/Videos/dashcam.flv ]
then
    echo "found previous recording"
    mv dashcam.flv /home/pi/Desktop/Videos/$(date+%F-%H:%M).dashcam.flv
...
echo "Started video at: $when" >> /home/pi/Desktop/Videos/dashcam.log

# record at 1024x760 with a Desktop preview window of 640x480, pipe to ffmpeg and output dashcam.flv 
raspivid -t 0 -w 1024 -h 760 -fps 25 -b 5000000 -p 0,0.640,480 -vf -o - | ffmpeg -i - -vcodec copy -an -f flv -r 25 -pix_fmt yuv420p /home/pi/Desktop/Videos/dashcam.flv -y